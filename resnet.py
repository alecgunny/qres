...
_FIRST_LAYER_BIT_WIDTH = 8


def conv3x3(in_planes, out_planes, bit_width, stride=1, groups=1, dilation=1):
    """3x3 convolution with padding"""
    return backend.make_quant_conv2d(
        in_planes,
        out_planes,
        bit_width=bit_width,
        kernel_size=3,
...
def conv1x1(in_planes, out_planes, bit_width, stride=1):
    """1x1 convolution"""
    return backend.make_quant_conv2d(
        in_planes,
        out_planes,
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = conv3x3(inplanes, planes, weight_bit_width, stride)
        self.bn1 = norm_layer(planes)
        self.relu1 = backend.make_quant_relu(
            bit_width=act_bit_width,
            per_channel_broadcastable_shape=(1, planes, 1, 1),
            scaling_per_channel=False,
            return_quant_tensor=True
        )

        self.conv2 = conv3x3(planes, planes, weight_bit_width)
        self.bn2 = norm_layer(planes)
        self.relu2 = backend.make_quant_relu(
            bit_width=act_bit_width,
            per_channel_broadcastable_shape=(1, planes, 1, 1),
            scaling_per_channel=False,
            return_quant_tensor=True
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.relu1 = backend.make_quant_relu(
            bit_width=act_bit_width,
            per_channel_broadcastable_shape=(1, width, 1, 1),
            scaling_per_channel=False,
            return_quant_tensor=True
        )
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = backend.make_quant_conv2d(
            3,
            self.inplanes,
            bit_width=_FIRST_LAYER_BIT_WIDTH,
            kernel_size=7,
            stride=2,
            padding=3,
            groups=1,
        ...
        self.relu = backend.make_quant_relu(
            bit_width=act_bit_width,
            per_channel_broadcastable_shape=(1, self.inplanes, 1, 1),
            scaling_per_channel=False,
